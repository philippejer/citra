...
void RendererOpenGL::DrawSingleScreen(const Layout::FramebufferLayout& layout,
                                      const ScreenInfo& screen_info, float x, float y, float w,
                                      float h) {
    const auto& texcoords = screen_info.display_texcoords;
 ...
 * rotation.
 */
void RendererOpenGL::DrawSingleScreenStereoRotated(const Layout::FramebufferLayout& layout,
...
void RendererOpenGL::DrawSingleScreenStereo(const Layout::FramebufferLayout& layout,
                                            const ScreenInfo& screen_info_l,
